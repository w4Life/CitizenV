...
public interface AddressRepo extends JpaRepository<Address, Integer> {
    ...
    @Query(value = "select case " +
        ...
        "end " + 
        "from addresses ad " + 
        "where ad.location = :location and ad.hamlet_code = :hamlet_code", nativeQuery = true)
    int existsByLocationAdnHamlet(@Param("location") String location, @Param("hamlet_code") String hamletCode);
